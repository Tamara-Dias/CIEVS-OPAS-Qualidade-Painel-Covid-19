...
dados <- dbFetch(res)
painelhoje <- as_tibble(dados)
rm(dados)

valoresMatriz <- read.xlsx('valoresMatrizRisco.xlsx')
...
# Dia 1 - mais antigo
linha1.1 <- texto_bruto1[grep("Total ", texto_bruto1$Linha), ]
linha1.1 <- linha1.1 %>%
  rowwise() %>%
  mutate_all(funs(str_squish(.))) %>%
  ungroup()
linha1.1 <- gsub(" ", ",", linha1.1, fixed = TRUE)
linha1.1 <- strsplit(as.character(linha1.1), ',')
linha1.1 <- data.frame(Linha=unlist(linha1.1))
p1.1 <- which(linha1.1$Linha == 'Total')
u1.1 <- length(linha1.1$Linha)
posicao1.1 <- as.numeric(linha1.1[p1.1:u1.1,])

linha2.1 <- texto_bruto1[grep("TOTAL GERAL ", texto_bruto1$Linha), ]
linha2.1 <- linha2.1 %>%
  rowwise() %>%
  mutate_all(funs(str_squish(.))) %>%
  ungroup()
linha2.1 <- gsub(" ", ",", linha2.1, fixed = TRUE)
linha2.1 <- strsplit(as.character(linha2.1), ',')
linha2.1 <- data.frame(Linha=unlist(linha2.1))
p2.1 <- which(linha2.1$Linha == 'GERAL')
u2.1 <- length(linha2.1$Linha)
posicao2.1 <- as.numeric(linha2.1[p2.1:u2.1,])

# Dia 2 
linha1.2 <- texto_bruto2[grep("Total ", texto_bruto2$Linha), ]
linha1.2 <- linha1.2 %>%
  rowwise() %>%
  mutate_all(funs(str_squish(.))) %>%
  ungroup()
linha1.2 <- gsub(" ", ",", linha1.2, fixed = TRUE)
linha1.2 <- strsplit(as.character(linha1.2), ',')
linha1.2 <- data.frame(Linha=unlist(linha1.2))
p1.2 <- which(linha1.2$Linha == 'Total')
u1.2 <- length(linha1.2$Linha)
posicao1.2 <- as.numeric(linha1.2[p1.2:u1.2,])

linha2.2 <- texto_bruto2[grep("TOTAL GERAL ", texto_bruto2$Linha), ]
linha2.2 <- linha2.2 %>%
  rowwise() %>%
  mutate_all(funs(str_squish(.))) %>%
  ungroup()
linha2.2 <- gsub(" ", ",", linha2.2, fixed = TRUE)
linha2.2 <- strsplit(as.character(linha2.2), ',')
linha2.2 <- data.frame(Linha=unlist(linha2.2))
p2.2 <- which(linha2.2$Linha == 'GERAL')
u2.2 <- length(linha2.2$Linha)
posicao2.2 <- as.numeric(linha2.2[p2.2:u2.2,])

# Dia 3 
linha1.3 <- texto_bruto3[grep("Total ", texto_bruto3$Linha), ]
linha1.3 <- linha1.3 %>%
  rowwise() %>%
  mutate_all(funs(str_squish(.))) %>%
  ungroup()
linha1.3 <- gsub(" ", ",", linha1.3, fixed = TRUE)
linha1.3 <- strsplit(as.character(linha1.3), ',')
linha1.3 <- data.frame(Linha=unlist(linha1.3))
p1.3 <- which(linha1.3$Linha == 'Total')
u1.3 <- length(linha1.3$Linha)
posicao1.3 <- as.numeric(linha1.3[p1.3:u1.3,])

linha2.3 <- texto_bruto3[grep("TOTAL GERAL ", texto_bruto3$Linha), ]
linha2.3 <- linha2.3 %>%
  rowwise() %>%
  mutate_all(funs(str_squish(.))) %>%
  ungroup()
linha2.3 <- gsub(" ", ",", linha2.3, fixed = TRUE)
linha2.3 <- strsplit(as.character(linha2.3), ',')
linha2.3 <- data.frame(Linha=unlist(linha2.3))
p2.3 <- which(linha2.3$Linha == 'GERAL')
u2.3 <- length(linha2.3$Linha)
posicao2.3 <- as.numeric(linha2.3[p2.3:u2.3,])

# Dia 4 
linha1.4 <- texto_bruto4[grep("Total ", texto_bruto4$Linha), ]
linha1.4 <- linha1.4 %>%
  rowwise() %>%
  mutate_all(funs(str_squish(.))) %>%
  ungroup()
linha1.4 <- gsub(" ", ",", linha1.4, fixed = TRUE)
linha1.4 <- strsplit(as.character(linha1.4), ',')
linha1.4 <- data.frame(Linha=unlist(linha1.4))
p1.4 <- which(linha1.4$Linha == 'Total')
u1.4 <- length(linha1.4$Linha)
posicao1.4 <- as.numeric(linha1.4[p1.4:u1.4,])

linha2.4 <- texto_bruto4[grep("TOTAL GERAL ", texto_bruto4$Linha), ]
linha2.4 <- linha2.4 %>%
  rowwise() %>%
  mutate_all(funs(str_squish(.))) %>%
  ungroup()
linha2.4 <- gsub(" ", ",", linha2.4, fixed = TRUE)
linha2.4 <- strsplit(as.character(linha2.4), ',')
linha2.4 <- data.frame(Linha=unlist(linha2.4))
p2.4 <- which(linha2.4$Linha == 'GERAL')
u2.4 <- length(linha2.4$Linha)
posicao2.4 <- as.numeric(linha2.4[p2.4:u2.4,])

# Dia 5 
linha1.5 <- texto_bruto5[grep("Total ", texto_bruto5$Linha), ]
linha1.5 <- linha1.5 %>%
  rowwise() %>%
  mutate_all(funs(str_squish(.))) %>%
  ungroup()
linha1.5 <- gsub(" ", ",", linha1.5, fixed = TRUE)
linha1.5 <- strsplit(as.character(linha1.5), ',')
linha1.5 <- data.frame(Linha=unlist(linha1.5))
p1.5 <- which(linha1.5$Linha == 'Total')
u1.5 <- length(linha1.5$Linha)
posicao1.5 <- as.numeric(linha1.5[p1.5:u1.5,])

linha2.5 <- texto_bruto5[grep("TOTAL GERAL ", texto_bruto5$Linha), ]
linha2.5 <- linha2.5 %>%
  rowwise() %>%
  mutate_all(funs(str_squish(.))) %>%
  ungroup()
linha2.5 <- gsub(" ", ",", linha2.5, fixed = TRUE)
linha2.5 <- strsplit(as.character(linha2.5), ',')
linha2.5 <- data.frame(Linha=unlist(linha2.5))
p2.5 <- which(linha2.5$Linha == 'GERAL')
u2.5 <- length(linha2.5$Linha)
posicao2.5 <- as.numeric(linha2.5[p2.5:u2.5,])

# Dia 6 
linha1.6 <- texto_bruto6[grep("Total ", texto_bruto6$Linha), ]
linha1.6 <- linha1.6 %>%
  rowwise() %>%
  mutate_all(funs(str_squish(.))) %>%
  ungroup()
linha1.6 <- gsub(" ", ",", linha1.6, fixed = TRUE)
linha1.6 <- strsplit(as.character(linha1.6), ',')
linha1.6 <- data.frame(Linha=unlist(linha1.6))
p1.6 <- which(linha1.6$Linha == 'Total')
u1.6 <- length(linha1.6$Linha)
posicao1.6 <- as.numeric(linha1.6[p1.6:u1.6,])

linha2.6 <- texto_bruto6[grep("TOTAL GERAL ", texto_bruto6$Linha), ]
linha2.6 <- linha2.6 %>%
  rowwise() %>%
  mutate_all(funs(str_squish(.))) %>%
  ungroup()
linha2.6 <- gsub(" ", ",", linha2.6, fixed = TRUE)
linha2.6 <- strsplit(as.character(linha2.6), ',')
linha2.6 <- data.frame(Linha=unlist(linha2.6))
p2.6 <- which(linha2.6$Linha == 'GERAL')
u2.6 <- length(linha2.6$Linha)
posicao2.6 <- as.numeric(linha2.6[p2.6:u2.6,])

# Dia 7
linha1.7 <- texto_bruto7[grep("Total ", texto_bruto7$Linha), ]
linha1.7 <- linha1.7 %>%
  rowwise() %>%
  mutate_all(funs(str_squish(.))) %>%
  ungroup()
linha1.7 <- gsub(" ", ",", linha1.7, fixed = TRUE)
linha1.7 <- strsplit(as.character(linha1.7), ',')
linha1.7 <- data.frame(Linha=unlist(linha1.7))
p1.7 <- which(linha1.7$Linha == 'Total')
u1.7 <- length(linha1.7$Linha)
posicao1.7 <- as.numeric(linha1.7[p1.7:u1.7,])

linha2.7 <- texto_bruto7[grep("TOTAL GERAL ", texto_bruto7$Linha), ]
linha2.7 <- linha2.7 %>%
  rowwise() %>%
  mutate_all(funs(str_squish(.))) %>%
  ungroup()
linha2.7 <- gsub(" ", ",", linha2.7, fixed = TRUE)
linha2.7 <- strsplit(as.character(linha2.7), ',')
linha2.7 <- data.frame(Linha=unlist(linha2.7))
p2.7 <- which(linha2.7$Linha == 'GERAL')
u2.7 <- length(linha2.7$Linha)
posicao2.7 <- as.numeric(linha2.7[p2.7:u2.7,])

# Dia 8 - dia atual
linha1.8 <- texto_bruto8[grep("Total ", texto_bruto8$Linha), ]
linha1.8 <- linha1.8 %>%
  rowwise() %>%
  mutate_all(funs(str_squish(.))) %>%
  ungroup()
linha1.8 <- gsub(" ", ",", linha1.8, fixed = TRUE)
linha1.8 <- strsplit(as.character(linha1.8), ',')
linha1.8 <- data.frame(Linha=unlist(linha1.8))
p1.8 <- which(linha1.8$Linha == 'Total')
u1.8 <- length(linha1.8$Linha)
posicao1.8 <- as.numeric(linha1.8[p1.8:u1.8,])

linha2.8 <- texto_bruto8[grep("TOTAL GERAL ", texto_bruto8$Linha), ]
linha2.8 <- linha2.8 %>%
  rowwise() %>%
  mutate_all(funs(str_squish(.))) %>%
  ungroup()
linha2.8 <- gsub(" ", ",", linha2.8, fixed = TRUE)
linha2.8 <- strsplit(as.character(linha2.8), ',')
linha2.8 <- data.frame(Linha=unlist(linha2.8))
p2.8 <- which(linha2.8$Linha == 'GERAL')
u2.8 <- length(linha2.8$Linha)
posicao2.8 <- as.numeric(linha2.8[p2.8:u2.8,])

total_suporte <- tail(posicao1.8, n = 1) #pega a última parte do vetor, que seria o total
total_publica <- tail(posicao2.8, n = 1)
```
...
# TAXAS DE OCUPAÇÃO ------------------------------------------------------
#Leitos
UTI_Publica_Direc <- sum(posicao2.8[3],posicao1.8[3])
UTI_Publica_Ocup <- sum(posicao2.8[4],posicao1.8[4])
UTI_Publica_Bloq <- sum(posicao2.8[5],posicao1.8[5])
UTI_Publica_Total <- sum(total_suporte,total_publica)
...
dia1 <- sum(posicao1.1[3:5], posicao2.1[3:5])
dia2 <- sum(posicao1.2[3:5], posicao2.2[3:5])
dia3 <- sum(posicao1.3[3:5], posicao2.3[3:5])
dia4 <- sum(posicao1.4[3:5], posicao2.4[3:5])
dia5 <- sum(posicao1.5[3:5], posicao2.5[3:5])
dia6 <- sum(posicao1.6[3:5], posicao2.6[3:5])
dia7 <- sum(posicao1.7[3:5], posicao2.7[3:5])
...
painel[,dataSin := as.Date(dataPrimeiroSintomas, "%Y-%m-%d")]
...
regcentral_obt <- regioesObt[grep("Região Central", rownames(regioesObt)), ]
regcentrosul_obt <- regioesObt[grep("Região Centro Sul", rownames(regioesObt)), ]
regleste_obt <- regioesObt[grep("Região Leste", rownames(regioesObt)), ]
regnorte_obt <- regioesObt[grep("Região Norte", rownames(regioesObt)), ]
regoeste_obt <- regioesObt[grep("Região Oeste", rownames(regioesObt)), ]
regsudoeste_obt <- regioesObt[grep("Região Sudoeste", rownames(regioesObt)), ]
regsul_obt <- regioesObt[grep("Região Sul", rownames(regioesObt)), ]
...
```{r include=FALSE}
# Penultima semana
central_obt_penul <- if (class(regcentral_obt) == "true"){
  central_obt_penul = 0
} else central_obt_penul = regcentral_obt[2]

centroSul_obt_penul <- if (class(regcentrosul_obt) == "true"){
  centroSul_obt_penul = 0
} else centroSul_obt_penul = regcentrosul_obt[2]

leste_obt_penul <- if (class(regleste_obt) == "true"){
  leste_obt_penul = 0
} else leste_obt_penul = regleste_obt[2]

norte_obt_penul <- if (class(regnorte_obt) == "true"){
  norte_obt_penul = 0
} else norte_obt_penul = regnorte_obt[2]

oeste_obt_penul <- if (class(regoeste_obt) == "true"){
  oeste_obt_penul = 0
} else oeste_obt_penul = regoeste_obt[2]

sudoeste_obt_penul <- if (class(regsudoeste_obt) == "true"){
  sudoeste_obt_penul = 0
} else sudoeste_obt_penul = regsudoeste_obt[2]

sul_obt_penul <- if (class(regsul_obt) == "true"){
  sul_obt_penul = 0
} else sul_obt_penul = regsul_obt[2]
...
central_obt_anti <- if (class(regcentral_obt) == "true"){
  central_obt_anti = 0
} else central_obt_anti = regcentral_obt[1]

centroSul_obt_anti <- if (class(regcentrosul_obt) == "true"){
  centroSul_obt_anti = 0
} else centroSul_obt_anti = regcentrosul_obt[1]

leste_obt_anti <- if (class(regleste_obt) == "true"){
  leste_obt_anti = 0
} else leste_obt_anti = regleste_obt[1]

norte_obt_anti <- if (class(regnorte_obt) == "true"){
  norte_obt_anti = 0
} else norte_obt_anti = regnorte_obt[1]

oeste_obt_anti <- if (class(regoeste_obt) == "true"){
  oeste_obt_anti = 0
} else oeste_obt_anti = regoeste_obt[1]

sudoeste_obt_anti <- if (class(regsudoeste_obt) == "true"){
  sudoeste_obt_anti = 0
} else sudoeste_obt_anti = regsudoeste_obt[1]

sul_obt_anti <- if (class(regsul_obt) == "true"){
  sul_obt_anti = 0
} else sul_obt_anti = regsul_obt[1]
...
# Variações
var_central_obt <- c()
if(class(regcentral_obt) == "table") {
  var_central_obt = -9999
} else if (regcentral_obt[1] == 0) {
  var_central_obt = regcentral_obt[2]*100
} else {
  var_central_obt = ((central_obt_penul-central_obt_anti)/central_obt_anti)*100
}
var_centroSul_obt <- c()
if(class(regcentrosul_obt) == "table") {
  var_centroSul_obt = -9999
} else if (regcentrosul_obt[1] == 0) {
  var_centroSul_obt = regcentrosul_obt[2]*100
} else {
  var_centroSul_obt = ((centroSul_obt_penul-centroSul_obt_anti)/centroSul_obt_anti)*100
}
var_leste_obt <- c()
if(class(regleste_obt) == "table") {
  var_leste_obt = -9999
} else if (regleste_obt[1] == 0) {
  var_leste_obt = regleste_obt[2]*100
} else {
  var_leste_obt = ((leste_obt_penul-leste_obt_anti)/leste_obt_anti)*100
}
var_norte_obt <- c()
if(class(regnorte_obt) == "table") {
  var_norte_obt = -9999
} else if (regnorte_obt[1] == 0) {
  var_norte_obt = regnorte_obt[2]*100
} else {
  var_norte_obt = ((norte_obt_penul-norte_obt_anti)/norte_obt_anti)*100
}
var_oeste_obt <- c()
if(class(regoeste_obt) == "table") {
  var_oeste_obt = -9999
} else if (regoeste_obt[1] == 0) {
  var_oeste_obt = regoeste_obt[2]*100
} else {
  var_oeste_obt = ((oeste_obt_penul-oeste_obt_anti)/oeste_obt_anti)*100
}
var_sudoeste_obt <- c()
if(class(regsudoeste_obt) == "table") {
  var_sudoeste_obt = -9999
} else if (regsudoeste_obt[1] == 0) {
  var_sudoeste_obt = regsudoeste_obt[2]*100
} else {
  var_sudoeste_obt = ((sudoeste_obt_penul-sudoeste_obt_anti)/sudoeste_obt_anti)*100
}
var_sul_obt <- c()
if(class(regsul_obt) == "table") {
  var_sul_obt = -9999
} else if (regsul_obt[1] == 0) {
  var_sul_obt = regsul_obt[2]*100
} else {
  var_sul_obt = ((sul_obt_penul-sul_obt_anti)/sul_obt_anti)*100
}
...
regcentral <- regioesCasos[grep("Região Central", rownames(regioesCasos)), ]
regcentrosul <- regioesCasos[grep("Região Centro Sul", rownames(regioesCasos)), ]
regleste <- regioesCasos[grep("Região Leste", rownames(regioesCasos)), ]
regnorte <- regioesCasos[grep("Região Norte", rownames(regioesCasos)), ]
regoeste <- regioesCasos[grep("Região Oeste", rownames(regioesCasos)), ]
regsudoeste <- regioesCasos[grep("Região Sudoeste", rownames(regioesCasos)), ]
regsul <- regioesCasos[grep("Região Sul", rownames(regioesCasos)), ]
...
```{r include=FALSE}
# Penultima semana
central_penul <- if (class(regcentral) == "true"){
  central_penul = 0
} else central_penul = regcentral[2]

centroSul_penul <- if (class(regcentrosul) == "true"){
  centroSul_penul = 0
} else centroSul_penul = regcentrosul[2]

leste_penul <- if (class(regleste) == "true"){
  leste_penul = 0
} else leste_penul = regleste[2]

norte_penul <- if (class(regnorte) == "true"){
  norte_penul = 0
} else norte_penul = regnorte[2]

oeste_penul <- if (class(regoeste) == "true"){
  oeste_penul = 0
} else oeste_penul = regoeste[2]

sudoeste_penul <- if (class(regsudoeste) == "true"){
  sudoeste_penul = 0
} else sudoeste_penul = regsudoeste[2]

sul_penul <- if (class(regsul) == "true"){
  sul_penul = 0
} else sul_penul = regsul[2]
...
```{r include=FALSE}
# Antipenultima semana
central_anti <- if (class(regcentral) == "true"){
  central_anti = 0
} else central_anti = regcentral[1]

centroSul_anti <- if (class(regcentrosul) == "true"){
  centroSul_anti = 0
} else centroSul_anti = regcentrosul[1]

leste_anti <- if (class(regleste) == "true"){
  leste_anti = 0
} else leste_anti = regleste[1]

norte_anti <- if (class(regnorte) == "true"){
  norte_anti = 0
} else norte_anti = regnorte[1]

oeste_anti <- if (class(regoeste) == "true"){
  oeste_anti = 0
} else oeste_anti = regoeste[1]

sudoeste_anti <- if (class(regsudoeste) == "true"){
  sudoeste_anti = 0
} else sudoeste_anti = regsudoeste[1]

sul_anti <- if (class(regsul) == "true"){
  sul_anti = 0
} else sul_anti = regsul[1]
...
# Variações
var_central <- c()
if(class(regcentral) == "table") {
  var_central = -9999
} else if (regcentral[1] == 0) {
  var_central = regcentral[2]*100
} else {
  var_central = ((central_penul-central_anti)/central_anti)*100
}
var_centroSul <- c()
if(class(regcentrosul) == "table") {
  var_centroSul = -9999
} else if (regcentrosul[1] == 0) {
  var_centroSul = regcentrosul[2]*100
} else {
  var_centroSul = ((centroSul_penul-centroSul_anti)/centroSul_anti)*100
}
var_leste <- c()
if(class(regleste) == "table") {
  var_leste = -9999
} else if (regleste[1] == 0) {
  var_leste = regleste[2]*100
} else {
  var_leste = ((leste_penul-leste_anti)/leste_anti)*100
}
var_norte <- c()
if(class(regnorte) == "table") {
  var_norte = -9999
} else if (regnorte[1] == 0) {
  var_norte = regnorte[2]*100
} else {
  var_norte = ((norte_penul-norte_anti)/norte_anti)*100
}
var_oeste <- c()
if(class(regoeste) == "table") {
  var_oeste = -9999
} else if (regoeste[1] == 0) {
  var_oeste = regoeste[2]*100
} else {
  var_oeste = ((oeste_penul-oeste_anti)/oeste_anti)*100
}
var_sudoeste <- c()
if(class(regsudoeste) == "table") {
  var_sudoeste = -9999
} else if (regsudoeste[1] == 0) {
  var_sudoeste = regsudoeste[2]*100
} else {
  var_sudoeste = ((sudoeste_penul-sudoeste_anti)/sudoeste_anti)*100
}
var_sul <- c()
if(class(regsul) == "table") {
  var_sul = -9999
} else if (regsul[1] == 0) {
  var_sul = regsul[2]*100
} else {
  var_sul = ((sul_penul-sul_anti)/sul_anti)*100
}
...
# > Variação Óbitos -------------------------------------------------------
varObitos <- matrix(c(
  (if(is.na(central_obt_anti)){0} else {central_obt_anti}), 
  (if(is.na(centroSul_obt_anti)){0} else {centroSul_obt_anti}), 
  (if(is.na(leste_obt_anti)){0} else {leste_obt_anti}), 
  (if(is.na(norte_obt_anti)){0} else {norte_obt_anti}), 
  (if(is.na(oeste_obt_anti)){0} else {oeste_obt_anti}), 
  (if(is.na(sudoeste_obt_anti)){0} else {sudoeste_obt_anti}), 
  (if(is.na(sul_obt_anti)){0} else {sul_obt_anti}), total_obt_anti, 
  (if(is.na(central_obt_penul)){0} else {central_obt_penul}), 
  (if(is.na(centroSul_obt_penul)){0} else {centroSul_obt_penul}), 
  (if(is.na(leste_obt_penul)){0} else {leste_obt_penul}), 
  (if(is.na(norte_obt_penul)){0} else {norte_obt_penul}), 
  (if(is.na(oeste_obt_penul)){0} else {oeste_obt_penul}), 
  (if(is.na(sudoeste_obt_penul)){0} else {sudoeste_obt_penul}), 
  (if(is.na(sul_obt_penul)){0} else {sul_obt_penul}), total_obt_penul, 
  paste0(round((if(var_central_obt == -9999){0} else {var_central_obt}),0),'%'), 
  paste0(round((if(var_centroSul_obt == -9999){0} else {var_centroSul_obt}),0),'%'), 
  paste0(round((if(var_leste_obt == -9999){0} else {var_leste_obt}),0),'%'), 
  paste0(round((if(var_norte_obt == -9999){0} else {var_norte_obt}),0),'%'), 
  paste0(round((if(var_oeste_obt == -9999){0} else {var_oeste_obt}),0),'%'), 
  paste0(round((if(var_sudoeste_obt == -9999){0} else {var_sudoeste_obt}),0),'%'),  
  paste0(round((if(var_sul_obt == -9999){0} else {var_sul_obt}),0),'%'),  
  paste0(round(var_total_obt,0),'%')), ncol=3, byrow = F)
...
# > Variação Casos --------------------------------------------------------
varCasos <- matrix(c(
  (if(is.na(central_anti)){0} else {central_anti}), 
  (if(is.na(centroSul_anti)){0} else {centroSul_anti}), 
  (if(is.na(leste_anti)){0} else {leste_anti}), 
  (if(is.na(norte_anti)){0} else {norte_anti}), 
  (if(is.na(oeste_anti)){0} else {oeste_anti}), 
  (if(is.na(sudoeste_anti)){0} else {sudoeste_anti}), 
  (if(is.na(sul_anti)){0} else {sul_anti}), total_anti, 
  (if(is.na(central_penul)){0} else {central_penul}), 
  (if(is.na(centroSul_penul)){0} else {centroSul_penul}), 
  (if(is.na(leste_penul)){0} else {leste_penul}), 
  (if(is.na(norte_penul)){0} else {norte_penul}), 
  (if(is.na(oeste_penul)){0} else {oeste_penul}), 
  (if(is.na(sudoeste_penul)){0} else {sudoeste_penul}), 
  (if(is.na(sul_penul)){0} else {sul_penul}), total_penul, 
  paste0(round((if(var_central == -9999){0} else {var_central}),0),'%'), 
  paste0(round((if(var_centroSul == -9999){0} else {var_centroSul}),0),'%'), 
  paste0(round((if(var_leste == -9999){0} else {var_leste}),0),'%'), 
  paste0(round((if(var_norte == -9999){0} else {var_norte}),0),'%'), 
  paste0(round((if(var_oeste == -9999){0} else {var_oeste}),0),'%'), 
  paste0(round((if(var_sudoeste == -9999){0} else {var_sudoeste}),0),'%'),  
  paste0(round((if(var_sul == -9999){0} else {var_sul}),0),'%'),  
  paste0(round(var_total,0),'%')), ncol=3, byrow = F)
...
# Indicadores
tabelaRisco <- data.frame(matrix(c("", paste0(leitos_UTI,'%'), pontosI1, 
                             paste0(leitos_UTI_clinicos,'%'), pontosI2,
                             dias_esg, pontosI3,
                             paste0(var_total_obt,'%'), pontosI4,
                             paste0(var_total,'%'), pontosI5,
                             atividade_DF, pontosI6), ncol=13))
...
sketch = htmltools::withTags(table(
  ...
  thead(
    tr(
      th(rowspan = 2,  ' '),
      th(colspan = 2, style = "border-right: solid 2px; border-top: solid 2px;", 'Taxa de ocupação de Leitos UTI COVID-19'),
      th(colspan = 2, style = "border-right: solid 2px; border-top: solid 2px;", 'Taxa de ocupação de Leitos Clínicos COVID-19'),
      th(colspan = 2, style = "border-right: solid 2px; border-top: solid 2px;", 'Previsão de Esgotamento de Leitos UTI'),
      th(colspan = 2, style = "border-right: solid 2px; border-top: solid 2px;", 'Variação do N° de Óbitos por COVID-19 nos últimos 14 dias'),
      th(colspan = 2, style = "border-right: solid 2px; border-top: solid 2px;", 'Variação do N° de casos por COVID-19 nos últimos 14 dias'),
      th(colspan = 2, style = "border-top: solid 2px;", 'Atividade')
    ),
    tr(
      th(paste0('DF ', "(", DFhoje, ")")),
      th(style = "border-right: solid 2px;", "Pontos"),
      th(paste0('DF ', "(", DFhoje, ")")),
      th(style = "border-right: solid 2px;", "Pontos"),
      th(paste0('DF ', "(", DFhoje, ")")),
      th(style = "border-right: solid 2px;", "Pontos"),
...
tabela2 <- datatable(tabelaRisco, container = sketch, rownames = FALSE, 
          options = list(lengthChange = FALSE, dom = 't',
                         columnDefs = list(list(className = 'dt-center', targets = 1:12)), 
                         columnDefs = list(list(targets = 3, visible = FALSE)), ordering = F)) %>% 
formatStyle(colnames(tabelaRisco)[2],colnames(tabelaRisco)[3],
              backgroundColor = styleEqual(c(0, 3, 6, 9, 12), c('yellowgreen', 'yellow', 'orange', 'orangered','mediumpurple'))) %>% 
  formatStyle(colnames(tabelaRisco)[4],colnames(tabelaRisco)[5],
              backgroundColor = styleEqual(c(0, 2, 4, 6, 8), c('yellowgreen', 'yellow', 'orange', 'orangered','mediumpurple'))) %>%
  formatStyle(colnames(tabelaRisco)[6],colnames(tabelaRisco)[7],
              backgroundColor = styleEqual(c(0, 1, 2, 3, 4), c('yellowgreen', 'yellow', 'orange', 'orangered','mediumpurple'))) %>%
  formatStyle(colnames(tabelaRisco)[8],colnames(tabelaRisco)[9],
              backgroundColor = styleEqual(c(0, 1, 2, 6, 8), c('yellowgreen', 'yellow', 'orange', 'orangered','mediumpurple'))) %>%
  formatStyle(colnames(tabelaRisco)[10],colnames(tabelaRisco)[11],
              backgroundColor = styleEqual(c(0, 1, 2, 3, 4), c('yellowgreen', 'yellow', 'orange', 'orangered','mediumpurple'))) %>%
  formatStyle(colnames(tabelaRisco)[12],colnames(tabelaRisco)[13],
              backgroundColor = styleEqual(c(0, 1, 2, 3, 4), c('yellowgreen', 'yellow', 'orange', 'orangered','mediumpurple'))) %>%
  formatStyle(c(3, 5, 7, 9, 11), `border-right` = "solid 2px")

html2 <- "tabela2.html"
saveWidget(tabela2, html2)
webshot(html2, paste0('Imagens_Matriz/', hoje, " Tabela 2 - Indicadores DF.png"), cliprect = c(28, 77, 1205, 215), zoom = 2)
```
...
tabelaE2RS <- matrix(c("Região Central", paste0(round((if(var_central_obt == -9999){0} else {var_central_obt}),0),'%'), PontosCentralObt, var_central_obt,
                       "Região Centro Sul", paste0(round((if(var_centroSul_obt == -9999){0} else {var_centroSul_obt}),0),'%'), PontosCentroSulObt, var_centroSul_obt,
                       "Região Leste",paste0(round((if(var_leste_obt == -9999){0} else {var_leste_obt}),0),'%'), PontosLesteObt, var_leste_obt,
                       "Região Norte", paste0(round((if(var_norte_obt == -9999){0} else {var_norte_obt}),0),'%'), PontosNorteObt, var_norte_obt,
                       "Região Oeste", paste0(round((if(var_oeste_obt == -9999){0} else {var_oeste_obt}),0),'%'), PontosOesteObt, var_oeste_obt,
                       "Região Sudoeste", paste0(round((if(var_sudoeste_obt == -9999){0} else {var_sudoeste_obt}),0),'%'), PontosSudoesteObt, var_sudoeste_obt,
                       "Região Sul", paste0(round((if(var_sul_obt == -9999){0} else {var_sul_obt}),0),'%'), PontosSulObt, var_sul_obt,
...
tabela3 <- datatable(tabelaE2RS[ , c(1, 2:4)], width = 550, container = sketch, rownames = FALSE, 
  ...
  formatStyle(colnames(tabelaE2RS)[2],colnames(tabelaE2RS)[3],
                      backgroundColor = styleEqual(c(0, 1, 2, 6, 8), c('yellowgreen', 'yellow', 'orange', 'orangered','mediumpurple')))
...
tabelaE2RSCasos <- matrix(c("Região Central", paste0(round((if(var_central == -9999){0} else {var_central}),0),'%'), PontosCentral, var_central,
                            "Região Centro Sul", paste0(round((if(var_centroSul == -9999){0} else {var_centroSul}),0),'%'), PontosCentroSul, var_centroSul,
                            "Região Leste", paste0(round((if(var_leste == -9999){0} else {var_leste}),0),'%'), PontosLeste, var_leste,
                            "Região Norte", paste0(round((if(var_norte == -9999){0} else {var_norte}),0),'%'), PontosNorte, var_norte,
                            "Região Oeste", paste0(round((if(var_oeste == -9999){0} else {var_oeste}),0),'%'), PontosOeste, var_oeste,
                            "Região Sudoeste", paste0(round((if(var_sudoeste == -9999){0} else {var_sudoeste}),0),'%'), PontosSudoeste, var_sudoeste,
                            "Região Sul", paste0(round((if(var_sul == -9999){0} else {var_sul}),0),'%'), PontosSul, var_sul,
...
tabela4 <- datatable(tabelaE2RSCasos[ , c(1, 2:4)], width = 540, container = sketch, rownames = FALSE,
  ...
  formatStyle(colnames(tabelaE2RSCasos)[2],colnames(tabelaE2RSCasos)[3],
                      backgroundColor = styleEqual(c(0, 1, 2, 3, 4), c('yellowgreen', 'yellow', 'orange', 'orangered','mediumpurple')))
...
tabela5 <- datatable(tabelaE2RSAtv[ , c(1, 2:4)], width = 450, container = sketch, rownames = FALSE, 
  ...
  formatStyle(colnames(tabelaE2RSAtv)[2],colnames(tabelaE2RSAtv)[3],
              backgroundColor = styleEqual(c(0, 1, 2, 3, 4), c('yellowgreen', 'yellow', 'orange', 'orangered','mediumpurple')))
