...
painelhoje <- read.xlsx('Último painel do dia.xlsx')
painel <- painelhoje %>% select("id", "RA", "dataPrimeiroSintomas", "classificacaoFinal", "dataObito", "Vacinado",
                                "Dose_1", "Dose_2", "Dose_Reforco")
rm(painelhoje) #removendo o painel com muitas variáveis
...
painel <- painel %>% mutate(dataSin = as.Date(dataPrimeiroSintomas, "%d/%m/%Y")) #casos
